...
benchmark_run_t benchmark_non_prime_modulo(uint64_t iterations) {
...
benchmark_run_t benchmark_power_of_two_bitmask(uint64_t iterations) {
...
benchmark_run_t benchmark_mersenne_prime_bitshift(uint64_t iterations) {
...
benchmark_results_t run_modulo_vs_bitshift_benchmark(uint64_t iterations) {
    ...
    uint64_t total = run1.result + run2.result + run3.result;
