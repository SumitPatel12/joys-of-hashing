#ifndef HLIST_FOR_HASH_TABLE_H
#define HLIST_FOR_HASH_TABLE_H
...
/*
 ...
 Linux Impl Link: https://github.com/torvalds/linux/blob/master/include/linux/list.h
...
struct hlist_node {
  ...
  /**
   * It is a pointer to the pointer that points to the next field of the previous node.
   * Not to be confused with a pointer to it's predecessor.
...
// TODO: Add null checks to all the methods.
